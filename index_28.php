...
<div class="mainnav1">
    ...
    <ul class="navbar-nav" style="padding:5px 50px;font-family:Microsoft YaHei; font-size:22px; width:100%">
        ...
        <li class="dropdown" style="width:8%;height:44px;"><a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="color:white;">认证<span class="caret"></span></a>
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="selfEvaluation.html">自我评估</a>
                </li>
                <li><a href="Phase query.html">认证申请</a>
                </li>
                <li><a href="Phase query.html">进度审查</a>
                </li>
                <li><a href="Qualification_inquiry.html">资质查询</a>
                </li>
            </ul>    
        ...
        <li class="dropdown" style="width:11%;height:44px;padding-left:0px;">
            ...
            <span class="caret"></span></a>
               <ul class="dropdown-menu">
                <li><a href="zxrc.html">最新日程</a></li>
                <li><a href="pxdt.html">培训动态</a></li>
                <li><a href="kcyl.html">课程一览</a></li>
                <li><a href="TTT.html">讲师申请</a></li>
        ...
        <li class="dropdown" style="padding-left:0px"><a href="#" class="dropdown-toggle" aria-haspopup="true" aria-expanded="true" data-toggle="dropdown"
         role="button" style="color:white; padding-left:18px;">示范中心<span class="caret"></span></a>
        	<ul class="dropdown-menu">
        ...
        aria-expanded="true" data-toggle="dropdown" role="button" style="color:white; padding-left:0px">基层胸痛<span class="caret"></span></a>
        	<ul class="dropdown-menu">
            	<li><a href="underConstruction.html">认证标准</a></li>
         ...
         <li class="dropdown" style="width:130px;height:44px;padding-left:20px;"><a href="#" class="dropdown-toggle" aria-haspopup="true" 
         aria-expanded="true" data-toggle="dropdown" role="button" style="color:white;padding-left:10px;">学习天地<span class="caret"></span></a>
        	<ul class="dropdown-menu">
        ...
        <li style="padding-left:20px"><a href="underConstruction.html" style="color:white;padding-left:20px;">星火计划</a></li>
    </ul>
